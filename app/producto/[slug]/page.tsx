...
import { ArrowLeft, Droplet, Sparkles } from "lucide-react";
...
export default function DetalleProducto() {
  ...
  // Nuevo estado para controlar qué imagen se está viendo en grande
  ...
  const fetchProduct = async () => {
    ...
    if (data) {
        setProduct(data);
        // Al cargar, establecemos la primera imagen como la principal
  ...
  // IMPORTANTE: Recuerda cambiar este número por el tuyo de ventas
  ...
  // Verificamos si el producto tiene una galería de varias imágenes
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
              ...
              <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
                {product.image_urls.map((url: string, index: number) => (
                  <button
                    ...
                    className={`flex-shrink-0 w-20 h-20 rounded-xl p-2 border-2 transition-all ${
                      mainImage === url 
          ...
          <div className="flex flex-col justify-center">
            ...
            <a
              ...
              className="bg-[#25D366] hover:bg-[#20bd5a] text-white text-center py-4 rounded-2xl font-bold text-lg transition-all flex items-center justify-center gap-3 shadow-lg shadow-green-200/50 hover:shadow-green-200 transform hover:-translate-y-1"
            >
              <svg 
                width="26" 
                height="26" 
